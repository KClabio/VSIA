...
const PAGE_DEFAULTS = {
  home: {
    ...
    homeBusiness2Title: 'TỔ CHỨC NGÀY HỘI & CUỘC THI STEM',
    ...
    trainingProgram1Title: 'Tập huấn, đào tạo kỹ thuật',
    trainingProgram1Text: 'Hướng dẫn giáo viên sử dụng, vận hành và khai thác thiết bị STEM, Robotics, AI trong phòng thực hành.',
    trainingProgram2Title: 'Tổng quan giáo dục STEM trong CTGDPT',
    trainingProgram2Text: 'Trang bị kiến thức nền tảng về giáo dục STEM và định hướng triển khai trong Chương trình giáo dục phổ thông.',
    trainingProgram3Title: 'Thực hành xây dựng các chủ đề dạy học STEM',
    trainingProgram3Text: 'Thực hành thiết kế và tổ chức các chủ đề dạy học STEM gắn với thực tiễn lớp học.',
    trainingProgram4Title: 'Nghiên cứu KHKT trong Giáo dục phổ thông',
    trainingProgram4Text: 'Trang bị phương pháp tổ chức và hướng dẫn học sinh thực hiện nghiên cứu khoa học kỹ thuật.',
    trainingProgram5Title: 'Thực hành các chủ đề nghiên cứu KHKT',
    trainingProgram5Text: 'Thực hành xây dựng đề tài, dự án nghiên cứu khoa học kỹ thuật cùng học sinh.',
    ...
    homeNewsEyebrow: 'TIN TỨC VÀ SỰ KIỆN GIÁO DỤC STEM',
    homeNewsTitle: 'TIN TỨC STEM TRONG NƯỚC VÀ QUỐC TẾ',
  ...
  'giai-phap': {
    ...
    heroSubtitle: 'VSIA đồng hành cùng nhà trường và địa phương xây dựng giáo dục STEM bền vững, từ con người, chương trình đến cơ sở vật chất.',
...
async function getPageContent(pageKey) {
  ...
  if (pageKey === 'home') {
    const businessTitleUpdates = {
      ...
      'Tổ chức & Thẩm định cuộc thi, sự kiện': 'TỔ CHỨC NGÀY HỘI & CUỘC THI STEM',
      'TỔ CHỨC & THẨM ĐỊNH CUỘC THI, SỰ KIỆN': 'TỔ CHỨC NGÀY HỘI & CUỘC THI STEM',
    ...
    const newsTitleUpdates = {
      ...
      'Hoạt động nổi bật': 'TIN TỨC STEM TRONG NƯỚC VÀ QUỐC TẾ',
      'DỰ ÁN VÀ HOẠT ĐỘNG STEM NỔI BẬT': 'TIN TỨC STEM TRONG NƯỚC VÀ QUỐC TẾ',
    };
