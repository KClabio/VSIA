...
const MODULE_ROLES = {
  ...
  'lien-he': ['admin', 'cskh'],
  'cai-dat': ['admin'],
  // Quyền sửa nội dung tại chỗ trên trang thật (nút "Sửa nội dung" ở header + API
  // /admin/noi-dung/*). Biên tập viên sửa được chữ/ảnh nhưng vẫn không vào được Cài đặt hệ thống.
  'noi-dung': ['admin', 'bien_tap'],
};
